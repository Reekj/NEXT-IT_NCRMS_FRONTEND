<template>
              ...
              <form class="mt-10 space-y-6" @submit.prevent="onSubmit">
                ...
                <div>
                  ...
                  <input
                    ...
                    type="text"
                    placeholder="Enter your service number (e.g. SA-0001)"
                  ...
                  <div class="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p class="mt-1 text-[12px] leading-5 text-black/60">
                        This system contains sensitive criminal record information.
  ...
  import { login } from "../../src/services/auth.service"; // adjust path if needed
  import { getApiErrorMessage } from "../../src/services/api"; // adjust path if needed
  ...
  async function onSubmit() {
    ...
    if (!form.serviceNumber || !form.password) {
      errorMsg.value = "Please enter your service number and password.";
      return;
    }
    ...
    try {
      ...
      // ✅ Store System Admin token
      localStorage.setItem("ncrms_token_admin", token);
  
      // Optional: store admin session info
