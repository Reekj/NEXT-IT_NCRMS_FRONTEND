<template>
    <DivisionalCoordinatorLayout :user="user">
      ...
      >
        <div class="border-b border-black/10 px-6 py-5 sm:px-8">
          <h2 class="text-[18px] font-semibold text-[#111827]">Edit Division Officer</h2>
        </div>
        ...
        <div v-if="loaded" class="px-6 py-7 sm:px-10 sm:py-10">
          ...
          <div class="grid grid-cols-1 gap-x-14 gap-y-10 md:grid-cols-2">
            ...
            <div>
              ...
              <input v-model="model.divisionId" type="text"
                class="h-14 w-full rounded-2xl border border-[#D7E3FF] bg-white px-5 text-[14px] text-[#6E88C7]
                       outline-none transition focus:border-[#0A2395] focus:ring-4 focus:ring-[#0A2395]/10" />
            </div>
            ...
            <div>
              <label class="mb-3 block text-[14px] font-medium text-[#111827]">Division Unit</label>
              <input v-model="model.unit" type="text"
                class="h-14 w-full rounded-2xl border border-[#D7E3FF] bg-white px-5 text-[14px] text-[#6E88C7]
                       outline-none transition focus:border-[#0A2395] focus:ring-4 focus:ring-[#0A2395]/10" />
            </div>
  ...
  onMounted(() => {
    ...
    model.value = { ...found, permissions: Array.isArray(found.permissions) ? [...found.permissions] : [] }
    loaded.value = true
  })
