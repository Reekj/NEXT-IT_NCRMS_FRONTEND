<!-- src/pages/roles/divisional_coordinator/divisional_coordinator_pages/Profile.vue -->
<template>
    <DivisionalCoordinatorLayout :user="user" headerTitle="Surulere Division">
      ...
      >
        ...
        <Motion
          tag="section"
          class="mt-6 rounded-3xl border border-black/10 bg-white p-6 shadow-sm sm:p-8"
        ...
        >
          ...
          <!-- ================= EDIT PROFILE ================= -->
          <div v-if="activeTab === 'edit'" class="mt-10 grid grid-cols-1 gap-10 lg:grid-cols-[220px_1fr]">
            <!-- Avatar -->
            <div class="flex justify-center lg:justify-start">
              <div class="relative">
                <div class="h-[140px] w-[140px] overflow-hidden rounded-full bg-black/5">
            ...
            <form class="grid grid-cols-1 gap-x-10 gap-y-6 md:grid-cols-2" @submit.prevent="saveProfile">
              ...
              <div class="md:col-span-2 flex justify-end">
                <Motion
                  tag="button"
                  type="submit"
                  class="mt-4 h-12 w-full rounded-xl bg-[linear-gradient(90deg,#0A2395_0%,#030B2F_100%)]
                         text-[14px] font-semibold text-white shadow-sm transition hover:opacity-95 active:opacity-90
                         sm:w-[200px] disabled:cursor-not-allowed disabled:opacity-70"
                  :disabled="saving"
          ...
          <div v-else class="mt-10 max-w-[720px]">
            ...
            <div class="mt-10 flex justify-end">
              <Motion
                tag="button"
                type="button"
                class="h-12 w-full rounded-xl bg-[linear-gradient(90deg,#0A2395_0%,#030B2F_100%)]
                       text-[14px] font-semibold text-white shadow-sm transition hover:opacity-95 active:opacity-90 sm:w-[200px]"
        ...
        >
          <div class="flex items-start gap-3">
            <div class="grid h-10 w-10 place-items-center rounded-xl border border-green-200 bg-green-50">
  ...
  const USER_STORAGE_KEY = "ncrms_dc_current_user";
  ...
  function writeCurrentUser(nextUser) {
    ...
    // keep same “header sync” pattern as your other roles
    window.dispatchEvent(new CustomEvent("ncrms-dc-user-updated"));
  }
  ...
  const form = ref({
    ...
    dob: "25 January 1990",
    presentAddress: "Surulere Division Address",
    permanentAddress: "Surulere Division Address",
    city: "Lagos",
    postalCode: "100001",
    country: "Nigeria",
  });
