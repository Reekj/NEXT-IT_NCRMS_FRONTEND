<template>
    <ZonalCoordinatorLayout>
      ...
      >
        ...
        <div class="border-b border-black/10 px-6 py-5 sm:px-8">
          <h2 class="text-[18px] font-semibold text-[#111827]">Add New State Command</h2>
        </div>
  ...
  function onSave() {
    // minimal: just return to list (API later)
    router.push({ path: "/zonal-coordinator/state-commands" })
  }
