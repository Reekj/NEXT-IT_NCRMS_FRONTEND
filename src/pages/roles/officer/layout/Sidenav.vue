<!-- src/pages/roles/officer/layout/Sidenav.vue -->
<template>
  <aside class="flex h-screen w-[260px] flex-col border-r border-black/10 bg-white">
    ...
    <div class="flex items-start gap-3 px-6 py-6">
      ...
      <div class="leading-tight">
        ...
        <div class="text-[12px] text-black/40">Officers</div>
...
/** Officer portal nav (matches the Officer screenshot) */
const navItems = [
  ...
  { label: "Forensic Evidence", to: "/officer/forensic-evidence", icon: Fingerprint },
]
