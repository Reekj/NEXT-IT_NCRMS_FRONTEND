<!-- src/pages/roles/state_command/state_command_pages/Profile.vue -->
<template>
  ...
  const USER_STORAGE_KEY = "ncrms_sc_current_user"
  ...
  function writeCurrentUser(nextUser) {
    ...
    // Layout/Header can listen to this like other roles
    window.dispatchEvent(new CustomEvent("ncrms-sc-user-updated"))
  }
  ...
  const form = ref({
    ...
    dob: "25 January 1990",
    presentAddress: "State Command Address",
    permanentAddress: "State Command Address",
    city: "Lagos",
    postalCode: "100001",
    country: "Nigeria",
  })
  ...
  ;(() => {
    ...
    // hydrate form name from stored user name
