      ...
      >
        ...
        >
          <div class="border-b border-black/10 px-6 py-5 sm:px-8">
            <h1 class="text-[20px] font-semibold text-black">Edit HQ Officer</h1>
          </div>
          ...
          <form v-else class="px-6 py-7 sm:px-8" @submit.prevent="onUpdate">
  ...
  function onUpdate() {
    ...
    const next = all.map((r) => {
      ...
      return {
        ...
        dateCreated: form.value.dateCreated || r.dateCreated,
